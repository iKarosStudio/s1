...
public class Main
{
	...
	public static void main (String[] args) throws InterruptedException {
		...
		/*
		 * Scanner KeyboardReader = new Scanner (System.in) ; do { //System.out.print
		 * ("#") ; String Cmd = KeyboardReader.nextLine () ; if (Cmd.equalsIgnoreCase
		 * ("exit") ) { Log.info ("收到停止命令") ; KeyboardReader.close () ; System.exit (0)
		 * ; } else { try { //PcInstance pc = world.getPc (Cmd) ; //System.out.println
		 * (pc.Uuid) ; } catch (Exception e) { e.printStackTrace () ; } } } while (true)
		 * ;
		 */
	}
}
